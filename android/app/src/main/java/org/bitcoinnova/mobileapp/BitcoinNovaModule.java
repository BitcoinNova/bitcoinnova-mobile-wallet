package org.bitcoinnova.mobileapp;
...
import org.bitcoinnova.mobileapp.BuildConfig;
...
public class BitcoinNovaModule extends ReactContextBaseJavaModule {
    static {
        System.loadLibrary("BitcoinNova_jni");
    }

    public BitcoinNovaModule(ReactApplicationContext reactContext) {
        super(reactContext); //required by React Native
    }

    /* Access this by doing NativeModules.BitcoinNova in react */
    @Override
    ...
    private void getWalletSyncDataImpl(
        ...
        try
        {
            ...
            /* tonchan-vx.x.x */
            connection.setRequestProperty("User-Agent", "bitcoinnova-mobile-wallet-v1.2.3");
