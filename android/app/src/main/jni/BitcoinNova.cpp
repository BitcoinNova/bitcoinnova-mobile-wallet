...
extern "C" jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    KEY_OUTPUT = (jclass) env->NewGlobalRef(env->FindClass("org/bitcoinnova/mobileapp/KeyOutput"));
    ...
    RAW_TRANSACTION = (jclass) env->NewGlobalRef(env->FindClass("org/bitcoinnova/mobileapp/RawTransaction"));
    RAW_TRANSACTION_CONST = env->GetMethodID(RAW_TRANSACTION, "<init>", "([Lorg/bitcoinnova/mobileapp/KeyOutput;Ljava/lang/String;Ljava/lang/String;)V");
    RAW_TRANSACTION_KEY_OUTPUTS = env->GetFieldID(RAW_TRANSACTION, "keyOutputs", "[Lorg/bitcoinnova/mobileapp/KeyOutput;");
    ...
    WALLET_BLOCK_INFO = (jclass) env->NewGlobalRef(env->FindClass("org/bitcoinnova/mobileapp/WalletBlockInfo"));
    WALLET_BLOCK_INFO_CONST = env->GetMethodID(WALLET_BLOCK_INFO, "<init>", "(Lorg/bitcoinnova/mobileapp/RawTransaction;[Lorg/bitcoinnova/mobileapp/RawTransaction;)V");
    WALLET_BLOCK_INFO_COINBASE_TRANSACTION = env->GetFieldID(WALLET_BLOCK_INFO, "coinbaseTransaction", "Lorg/bitcoinnova/mobileapp/RawTransaction;");
    WALLET_BLOCK_INFO_TRANSACTIONS = env->GetFieldID(WALLET_BLOCK_INFO, "transactions", "[Lorg/bitcoinnova/mobileapp/RawTransaction;");

    TRANSACTION_INPUT = (jclass) env->NewGlobalRef(env->FindClass("org/bitcoinnova/mobileapp/TransactionInput"));
    ...
    SPEND_KEY = (jclass) env->NewGlobalRef(env->FindClass("org/bitcoinnova/mobileapp/SpendKey"));
    ...
    INPUT_MAP = (jclass) env->NewGlobalRef(env->FindClass("org/bitcoinnova/mobileapp/InputMap"));
    INPUT_MAP_CONST = env->GetMethodID(INPUT_MAP, "<init>", "(Ljava/lang/String;Lorg/bitcoinnova/mobileapp/TransactionInput;)V");
    INPUT_MAP_PUBLIC_SPEND_KEY = env->GetFieldID(INPUT_MAP, "publicSpendKey", "Ljava/lang/String;");
    INPUT_MAP_TRANSACTION_INPUT = env->GetFieldID(INPUT_MAP, "input", "Lorg/bitcoinnova/mobileapp/TransactionInput;");
...
Java_org_bitcoinnova_mobileapp_BitcoinNovaModule_processBlockOutputsJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_org_bitcoinnova_mobileapp_BitcoinNovaModule_generateRingSignaturesJNI(
    JNIEnv *env,
    jobject instance,
    jstring jPrefixHash,
    jstring jKeyImage,
...
Java_org_bitcoinnova_mobileapp_BitcoinNovaModule_checkRingSignatureJNI(
    JNIEnv *env,
    jobject instance,
    jstring jPrefixHash,
    jstring jKeyImage,
...
Java_org_bitcoinnova_mobileapp_BitcoinNovaModule_generateKeyDerivationJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jstring JNICALL
Java_org_bitcoinnova_mobileapp_BitcoinNovaModule_generateKeyImageJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jstring JNICALL
Java_org_bitcoinnova_mobileapp_BitcoinNovaModule_deriveSecretKeyJNI(
    JNIEnv *env,
    jobject instance,
    jstring jDerivation,
    jlong outputIndex,
...
extern "C" JNIEXPORT jstring JNICALL
Java_org_bitcoinnova_mobileapp_BitcoinNovaModule_derivePublicKeyJNI(
    JNIEnv *env,
    jobject instance,
    jstring jDerivation,
    jlong outputIndex,
