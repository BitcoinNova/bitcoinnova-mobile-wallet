...
export async function generateKeyImage(
    publicEphemeral,
    privateEphemeral) {
    return NativeModules.BitcoinNova.generateKeyImage(
...
export async function deriveSecretKey(
    ...
    outputIndex,
    privateSpendKey) {
    return NativeModules.BitcoinNova.deriveSecretKey(
...
export async function derivePublicKey(
    ...
    outputIndex,
    publicSpendKey) {
    return NativeModules.BitcoinNova.derivePublicKey(
...
export async function generateKeyDerivation(
    ...
    return NativeModules.BitcoinNova.generateKeyDerivation(
...
export async function generateRingSignatures(
    ...
    privateKey,
    realIndex) {
    return NativeModules.BitcoinNova.generateRingSignatures(
...
export async function checkRingSignature(
    ...
    publicKeys,
    signatures) {
    return NativeModules.BitcoinNova.checkRingSignature(
...
export async function makePostRequest(endpoint, body) {
    ...
    let data = await NativeModules.BitcoinNova.getWalletSyncData(
        count,
        checkpoints,
        skipCoinbaseTransactions,
        height,
    ...
    if (data.error) {
        ...
        data = await NativeModules.BitcoinNova.getWalletSyncData(
            count,
            checkpoints,
            skipCoinbaseTransactions,
            height,
...
export async function processBlockOutputs(
    ...
    let inputs = await NativeModules.BitcoinNova.processBlockOutputs(
